...
/**
 * Created by susy on 14/04/2017.
 */
public class Test2 {
    static String fromuid="3001";
    ...
    public static void main(String[] args){
        ...
        ResponseDelegate delegate = new ResponseDelegate() {
            ...
            public void receiveByte(PClient<? extends PRequest, ? extends AbstractPResponse> pclient, String[] head, byte[] message) {
                ...
                //System.out.println("fuid:"+fuid+",type:"+type+",page:"+page+",sn:"+sn);
        ...
        while (run) {
            ...
            try {
                if ("exit".equalsIgnoreCase(info)) {
                    ...
                    rec = PSReceiver.getInstance("tk00005", "3002", "172.16.24.41", 19999);//127.0.0.1
