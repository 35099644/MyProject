...
public final class IOUtils {
     ...
     * @param fileName
     */
    public synchronized static void stringToFile(boolean append,String str, String fileName, Context context) throws IOException {
     ...
     * @param path
     */
    public synchronized static void stringToFile(boolean append,String str,String path) throws IOException {
     ...
     * @param file
     */
    public synchronized static String fileToString(String file) throws IOException {
